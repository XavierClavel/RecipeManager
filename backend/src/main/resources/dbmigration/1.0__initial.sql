...
create table recipes_cookbooks (
  recipes_id                    bigint not null,
  cookbooks_id                  bigint not null,
  constraint pk_recipes_cookbooks primary key (recipes_id,cookbooks_id)
);
...
create index ix_recipes_cookbooks_recipes on recipes_cookbooks (recipes_id);
alter table recipes_cookbooks add constraint fk_recipes_cookbooks_recipes foreign key (recipes_id) references recipes (id) on delete restrict on update restrict;

create index ix_recipes_cookbooks_cookbooks on recipes_cookbooks (cookbooks_id);
alter table recipes_cookbooks add constraint fk_recipes_cookbooks_cookbooks foreign key (cookbooks_id) references cookbooks (id) on delete restrict on update restrict;
