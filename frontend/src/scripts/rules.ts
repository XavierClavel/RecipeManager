...
const max511 = v => !v || v.length <= 511 || t('max_500_characters')
const max255 = v => !v || v.length <= 255 || t('max_200_characters')
const max100 = v => !v || v.length <= 100 || t('max_100_characters')
const max50 = v => !v || v.length <= 50 || t('max_50_characters')
